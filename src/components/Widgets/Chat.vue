						...
						<div class="chat-block mb-2" :key="index" :class="{'flex-row-reverse': chat.isAdmin}">
							<template v-if="chat.isAdmin">
								...
								<div class="chat-bubble-wrap">
									<span class="fs-12 fw-normal grey--text text-xs-right d-block mb-1">{{chat.adminName}}</span>
							...
							<template v-else>
								...
								<div class="chat-bubble-wrap">
									<span class="fs-12 grey--text d-block mb-1 fw-normal">{{chat.userName}}</span>
