				...
				<div class="pa-3 authors-info">
					...
					<ul class="list-unstyled author-contact-info mb-2">
						<li>
							...
							<a href="tel:123456" class="fs-12 grey--text fw-normal">{{author.profileInfo.phone}}</a>
						</li>
						<li>
							<span class="mr-3"><i class="zmdi zmdi-email"></i></span>
							<a href="mailto:joan_parisian@gmail.com" class="fs-12 grey--text fw-normal">{{author.profileInfo.email}}</a>
						</li>
						<li>
